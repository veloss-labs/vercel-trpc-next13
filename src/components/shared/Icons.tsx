...
type CommonCustomSvgProps = React.SVGProps<SVGSVGElement>;

const CustomGithubIcon: React.FC<CommonCustomSvgProps> = (props) => (
  <svg
    aria-hidden="true"
    focusable="false"
    data-prefix="fab"
...
const CustomLoadingIcon: React.FC<CommonCustomSvgProps> = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
